class Solution {
    ...
    *	1. Just don't visit already visited node. (Handling of Cycle and Undirected 2-way edges)
    ...
    *	2. Traverse from each source node (Handling of disjoint graph (directed/undirected) and Forked directed graph)
	*		2.1	Handles traversing all disconnected components in disjoint graphs
 	*		2.2	Handles visiting all sources in Forked directed graphs
    */
